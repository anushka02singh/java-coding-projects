...
public class Warehouse {
    ...
    private void evictIfNeeded(int id) 
    {
        ...
        {
            sectors[index].swap(1, sectors[index].getSize());
    ...
    {
        int index = id % 10;
        for(int i = 1; i <= sectors[index].getSize(); i++)
        {
    ...
    public void deleteProduct(int id) 
    {
        ...
        for(int i = 1; i <= sectors[index].getSize(); i++)
        {
            ...
            if(sectors[index].get(i).getId() == id)
            {
                sectors[index].swap(i, sectors[index].getSize());
                //System.out.print(sectors[index].getSize());
                sectors[index].deleteLast();
    ...
    public void purchaseProduct(int id, int day, int amount) 
    {
        ...
        for(int i = 1; i <= sectors[index].getSize(); i++)
        {
            if(sectors[index].get(i).getId() == id)
            {
                ...
                {
                    sectors[index].get(i).updateStock(amount * -1);
                    sectors[index].get(i).updateDemand(amount);
                    sectors[index].get(i).setLastPurchaseDay(day);
                    if(sectors[index].get(i).getStock() == 0)
                    {
                        deleteProduct(id);
                    }
                    else sectors[index].sink(i);
        ...
        else
        {
            ...
            while(i != index)
            {
               //System.out.println(i);
                ...
                {
                    addToEnd(i, name, stock, day, demand);
                    fixHeap(i);
